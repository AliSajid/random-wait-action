...
This original source code of this project is licensed under the [MIT License](_media/MIT.txt). Other non-essential files are licensed under the [CC0 Public Domain Dedication](_media/CC0-1.0.txt) and the author(s) dedicate them to the public domain.
